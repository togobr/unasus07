...
define('text!main/template.html',[],function () { return '<div class="wrapper" id="{{_id}}">\n\t<div class="ajuda" style="display: none"></div>\n\n\t<div class="menuIndice" style="display: none">\n\t\t<div class="avancarIndice"></div>\n\t\t<div class="voltarIndice"></div>\n\t\t<ol id="indice" style="right:0px">\n\t\t\t{{#slides}}\n\t\t\t\t<li class="slideIten indiceDesativado">\n\t\t\t\t\t<div class="blackMask"></div>\n\t\t\t\t\t<h3>{{name}}</h3>\n\t\t\t\t</li>\n\t\t\t{{/slides}}\t\t\t\t\t\n\t\t</ol>\n\t</div>\n\n\t<div class="menu">\n\t\t<img class="logo" src="css/assets/images/logo.png" alt="logo">\n\n\t\t<div class="btnsMenu">\n\t\t\t<div class="botaoIndice">\n\t\t\t\t<div class="iconP3 iconP3-indice"></div>\n\t\t\t\t<span>Índice</span>\n\t\t\t</div>\n\t\t\t<div class="botaoAjuda">\n\t\t\t\t<div class="iconP3 iconP3-ajuda"></div>\n\t\t\t\t<span>Ajuda</span>\n\t\t\t</div>\n\t\t</div>\t\n\t</div>\n\n\t<div class="top">\n\t\t<div class="courseName"> <h5>{{courseName}}</h5> </div>\n\t\t<span id="pipe">|</span>\n\t\t<div class="scoName"> <h5>{{courseName}}</h5> </div>\n\t\n\t\t<div class="slideControls">\n\t\t\t<div class="botaoVoltar"></div>\n\n\t\t\t<div class="valorSlide">\n\t\t\t\t<div class="valorSlideAtual">\n\t\t\t\t\t<span id="sldAtual"></span>/<span id="sldTotal"></span>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\t\t\t<div class="botaoAvancar"></div>\n\t\t</div>\n\t\t\n\t</div>\n\n\t<div id="slider" class="swipe middle">\n\t\t<div class="swipe-wrap"></div>\n\t</div>\n\t\n\t</div>\n</div>\n\n';});
...
define('../../../../../player/_base/js/components/recSequentialEntry',[
	"jquery"
	], function($) {
...
define('../../../_base/js/desktop/main/player',[
	...
	var baseplayer = function(player) {
		...
		this.updateScorm = function(slide) {
			...
			if (Number(slide) === (totalSlides - 1) || scormStatus === 'completed') {
...
define('text!../../../_base/js/desktop/slides/default/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}" id="{{_id}}" class="{{class}}">\n\t\n</div>\n';});


define('text!slides/slideCapa/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t</div>\n</div>\n';});

define('slides/slideCapa/player',[
	'jquery'
	], function($) {
...
define('text!slides/slideCapa2/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa2">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t</div>\n</div>\n';});

define('slides/slideCapa2/player',[
	'jquery'
	], function($) {
...
define('text!slides/slideCapa3/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa3">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t\t<ul class="yellowStripes">\n\t\t\t<li></li> <li></li> <li></li> <li></li> <li></li>\n\t\t</ul>\n\t</div>\n</div>\n';});

define('slides/slideCapa3/player',[
	'jquery'
	], function($) {
...
define('text!slides/slideCapa4/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa4">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t\t<ul class="yellowStripes">\n\t\t\t<li></li> <li></li> <li></li>\n\t\t</ul>\n\t</div>\n</div>\n';});

define('slides/slideCapa4/player',[
	'jquery'
	], function($) {
...
define('text!slides/template1/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});

define('slides/template1/player',[
	'jquery'
	], function($) {
...
define('text!slides/template2/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});

define('slides/template2/player',[
	'jquery'
	], function($) {
...
define('text!slides/template3/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


define("json!slides/template3/config.json", function(){ return {
	"defaults": {
...
define('slides/template3/editor',[], function() {
...
define('text!../../../_base/js/desktop/resources/imagem/template.html',[],function () { return '<div class="table {{class}} {{#border}}borda{{/border}} {{#zoom}}zoomImg{{/zoom}}" id="{{_id}}" style="{{style}}">\n\t<div class="trow">\n\t\t<div class="tcell">\n\t\t\t<div id="imageWrapper" class="{{^src}}noContent{{/src}}">\n\t\t\t\t<img src="{{#src}} {{src}} {{/src}}"/>\n\t\t\t\t<span class="glyphicon glyphicon-picture"></span>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t{{#legend.active}}\n\t\t<div class="trow">\n\t\t\t<div class="tcell">\n\t\t\t\t<div id="recImglegendaContent"><span class="legendText">{{&legend.content}}</span></div>\n\t\t\t</div>\n\t\t</div>\n\t{{/legend.active}}\n</div>\n\n';});
...
define("zoom", ["jquery"], function(){});

define('../../../_base/js/desktop/resources/imagem/player',[
	"zoom"
], function() {
...
define('text!../../../_base/js/desktop/resources/botaoPP/template.html',[],function () { return '<div style="position: absolute; top: 0px;"> <!--Criado um elemento sem altura definida, para o botaoPP poder redimensionar verticalmente de acordo com o texto inserido no Editor.-->\n\t<div id="{{_id}}" class="{{class}} {{#type}}{{type}}{{/type}}" style="{{style}}">\n\t\t<div class="plus"></div>\n\t\t<div class="btnPPLeft">\t\n\t\t\t<div class="iconP3 iconP3-modal"></div>\n\t\t</div>\n\t\t<div class="btnPPRight"> \n\t\t\t<div class="tagP">{{&label}}</span>\n\t\t</div>\n\t</div>\n</div>';});


define('text!../../../_base/js/desktop/resources/botaoPP/modal.html',[],function () { return '<div class="primeiroPlano {{^type}}ppGrande{{/type}} {{type}}" style="{{style}}">\n\t<div class="btnFechar">\n\t\t<div class="iconP3 iconP3-fechar"></div>\n\t</div>\n\t<div id="modalContent"></div>\n</div>';});

/*
	Não importar jquery pois compilação entrega para ele. Explicar melhor na hora de documentar
*/

define('../../../_base/js/desktop/resources/botaoPP/player',[], function() {
...
define('text!../../../_base/js/desktop/resources/video/template.html',[],function () { return '<div id="{{_id}}" class="{{class}}" style="{{style}}">\n\t<video class="inVideo video-js vjs-default-skin" width="100%" height="100%" controls></video>\n\t<span class="glyphicon glyphicon-facetime-video"></span>\n</div>\n\n';});

/*
	Não importar jquery pois compilação entrega para ele. Explicar melhor na hora de documentar
*/

define('../../../_base/js/desktop/resources/video/player',[], function() {
...
define('../../../_base/js/desktop/resources/video/generalInit',[
	"videojs",
	'videojsyoutube',
	'videojsvimeo'
...
define('text!../../../_base/js/desktop/resources/texto/template.html',[],function () { return '<div id="{{_id}}" class="{{class}}{{#normal.active}} normal {{normal.subType}}{{/normal.active}}{{#balao.active}} balao {{balao.subType}}{{/balao.active}}{{#titulo.active}} titulo {{titulo.subType}}{{/titulo.active}}" style="{{style}}">\n\t<div class="tagP">{{&content}}</div>\n</div>';});

define('../../../_base/js/desktop/resources/texto/player',['jquery'], function($) {
...
define('text!../../../_base/js/desktop/resources/audio/template.html',[],function () { return '<div id="{{_id}}" class="{{class}}" style="{{style}}">\n\t<audio class="video-js vjs-default-skin" width="100%" height="100%" controls></audio>\n\t<span class="glyphicon glyphicon-music"></span>\n</div>';});

define('../../../_base/js/desktop/resources/audio/player',['jquery'], function($) {
...
Cuidados devem ser tomados pois o escopo das duas chamadas é diferente
*/
define('../../../_base/js/desktop/resources/audio/generalInit',[
	"videojs",
	'videojsyoutube',
	'videojsvimeo'
], function(videojs, videojsyoutube, videojsvimeo) {
...
define('text!../../../_base/js/desktop/resources/multimedia/template.html',[],function () { return '<div id="{{_id}}" class="{{class}} {{^src}}noContent{{/src}}" style="{{style}}" >\n\t<iframe src="{{#src}} {{src}} {{/src}}" width="100%" height="100%" style="border: 0px; {{^src}}background: #e7e7e7;{{/src}}">\n\t\t<p>Your browser does not support iframes.</p>\n\t</iframe>\n\n\t<span class="glyphicon glyphicon-edit"></span>\n</div>\n';});

define('../../../_base/js/desktop/resources/multimedia/player',[], function() {
...
define("json!../../../_base/config/general.json", function(){ return {
	"swipe": {
		"startSlide": 0,
		"speed": 500,
		"altura": 540,
...
define("json!../../../_base/config/selectors.json", function(){ return {
	"content": ".swipe-wrap",
	"swipe": "#slider",
	"templateIndice": "slideIndice"
};});
