...
player.define("json!../../../_base/config/stage/main.json", function(){ return {
	"resources": [{
			"active": true,
			"template": "texto",
...
player.define("json!../../../_base/config/stage/modal.json", function(){ return {
	"resources": [{
			"active": true,
			"template": "texto",
			"label": "Caixa de Texto",
...
player.define('text!slides/slideCapa/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t</div>\n</div>\n';});


player.define("json!slides/slideCapa/config.json", function(){ return {
	"defaults": {
		"title": "Exemplo de Capa Simples"
	},
...
player.define('slides/slideCapa/editor',[], function() {
...
player.define('text!slides/slideCapa2/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa2">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t</div>\n</div>\n';});


player.define("json!slides/slideCapa2/config.json", function(){ return {
	"defaults": {
		"title": "Exemplo de Capa Simples"
	},
...
player.define('slides/slideCapa2/editor',[], function() {
...
player.define('text!slides/slideCapa3/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa3">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t\t<ul class="yellowStripes">\n\t\t\t<li></li> <li></li> <li></li> <li></li> <li></li>\n\t\t</ul>\n\t</div>\n</div>\n';});


player.define("json!slides/slideCapa3/config.json", function(){ return {
	"defaults": {
		"title": "Exemplo de Capa Simples"
	},
...
player.define('slides/slideCapa3/editor',[], function() {
...
player.define('text!slides/slideCapa4/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa4">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t\t<ul class="yellowStripes">\n\t\t\t<li></li> <li></li> <li></li>\n\t\t</ul>\n\t</div>\n</div>\n';});


player.define("json!slides/slideCapa4/config.json", function(){ return {
	"defaults": {
		"title": "Exemplo de Capa Simples"
	},
...
player.define('slides/slideCapa4/editor',[], function() {
...
player.define('slides/slideFinal/editor',[], function() {
...
player.define('text!slides/template1/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


player.define("json!slides/template1/config.json", function(){ return {
	"defaults": {
	...
	"resources": {
		...
		"insert": [
				{  
		            ...
		            {  
		               "_id":"5462397edb461a0d1d00000f",
		               "balao":{  
		                  "active":false,
		                  "subType":"left"
		               },
		               "content":"Nullam massa metus, ornare eu vulputate vel, bibendum sit amet leo. Donec sed metus sit amet diam convallis egestas. Nunc dictum arcu congue orci sagittis, sed placerat diam mattis.&nbsp;<div><br></div><div>Nunc ac efficitur sapien. Etiam non neque tristique, pellentesque neque a, iaculis ante. Morbi sed enim ullamcorper, eleifend elit et, interdum felis. Morbi non diam tristique, ultricies massa quis, iaculis augue.</div>",
		               "normal":{  
		                  "subType":"semFundo",
		                  "active":true
		               },
...
player.define('slides/template1/editor',[], function() {
...
player.define('text!slides/template2/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


player.define("json!slides/template2/config.json", function(){ return {
	"defaults": {
	...
	"resources": {
		...
		"insert": [
			{  
               ...
               "id":"texto3",
               "class":"texto",
               "style":"left:22px;top:33px;width:234px;position:absolute;"
            },
            {  
               "_id":"54624d11db461a0d1d00002b",
               "baseImg":"",
               "border":false,
               "imgHeight":422,
               "legend":{  
               ...
               "id":"imagem5",
               "class":"imagem",
               "style":"position:absolute;top:116px;left:45.578125px;height:422px;width:295.578125px;"
            },
            {  
               "_id":"54624c00db461a0d1d000028",
               "balao":{  
                  "subType":"left",
                  "active":true
               },
               "content":"Lorem ipsum Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.&nbsp;<div><br></div><div>Lorem ipsum Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.&nbsp;Lorem ipsum&nbsp;Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.</div><div><br></div><div>Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.<br></div>",
               "normal":{  
                  "subType":"comFundo",
                  "active":false
               },
               ...
               "id":"texto4",
               "class":"texto",
               "style":"position:absolute;width:427px;top:65px;left:387.53125px;"
            },
            {  
               "_id":"54624cc2db461a0d1d00002a",
               ...
               "id":"caixaDestaque1",
               "class":"caixaDestaque",
               "style":"left:387.53125px;top:329.109375px;width:427px;position:absolute;"
            }
...
player.define('slides/template2/editor',[], function() {
...
player.define('text!slides/template3/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


player.define("json!slides/template3/config.json", function(){ return {
	"defaults": {
	...
	"resources": {
		...
		"insert": [
          {  
               ...
               "id":"texto1",
               "class":"texto",
               "style":"left:31px;top:33px;width:217px;position:absolute;"
            },
            {  
               "_id":"546251a3db461a0d1d000036",
               "balao":{  
                  "active":false,
                  "subType":"left"
               },
               "content":"Lorem ipsum Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.&nbsp;Lorem ipsum Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.<div><br><div>Lorem ipsum Aliqua nostrud occaecat anim elit culpa ut magna velit esse deserunt.<br><div><br></div></div></div>",
               "normal":{  
                  "active":true,
                  "subType":"semFundo"
               },
               ...
               "id":"texto2",
               "class":"texto",
               "style":"position:absolute;width:419px;top:188px;left:45.578125px;"
            },
            {  
               "_id":"546251cbdb461a0d1d000037",
               "balao":{  
                  "active":false,
                  "subType":"left"
               },
               "content":"Lorem ipsum Aliqua nostrud.",
               "normal":{  
                  "active":false,
                  "subType":"semFundo"
               },
               ...
               "id":"texto3",
               "class":"texto",
               "style":"position:absolute;width:433px;top:125px;left:9px;"
            },
            {  
               "_id":"546251f3db461a0d1d000038",
               "balao":{  
                  "active":false,
                  "subType":"right"
               },
               "content":"<b>Lorem ipsum Aliqua nostrud occaecat animoccaecat&nbsp;nostrud.</b>",
               "normal":{  
                  "active":true,
                  "subType":"semFundo"
               },
               ...
               "id":"texto4",
               "class":"texto",
               "style":"left:45.578125px;top:348px;width:448px;position:absolute;"
            },
            {  
               "_id":"54625237db461a0d1d000039",
               "content":"Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit.<div><br></div><div>Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit.<br></div>",
               "order":"4",
               "styleObj":{  
                  "position":"absolute",
                  "width":"294px",
               ...
               "id":"caixaDestaque1",
               "class":"caixaDestaque",
               "style":"position:absolute;width:294px;top:128px;left:533.671875px;"
            }
		]
	}
}
...
player.define('slides/template3/editor',[], function() {
...
player.define('../../../_base/js/desktop/resources/audio/editor',[], function() {
...
*/
player.define('../../../_base/js/desktop/resources/audio/generalInit',[
	"videojs",
	'videojsyoutube',
	'videojsvimeo'
...
player.define('../../../_base/js/desktop/resources/multimedia/editor',[], function() {
...
player.define('resources/caixaDestaque/editor',[], function() {
...
player.define('../../../_base/js/desktop/resources/imagem/editor',[], function() {
...
player.define('../../../_base/js/desktop/resources/video/editor',[
	"videojs",
	'videojsyoutube',
	'videojsvimeo'
], function(videojs, videojsyoutube, videojsvimeo) {
...
player.define('../../../_base/js/desktop/resources/video/generalInit',[
	"videojs",
	'videojsyoutube',
	'videojsvimeo'
], function(videojs, videojsyoutube, videojsvimeo) {
...
player.define('../../../_base/js/desktop/resources/texto/editor',[], function() {
...
player.define('../../../_base/js/desktop/resources/botaoPP/editor',[], function() {
...
player.define('../../../_base/js/desktop/resources/atividade/editor',[], function() {
...
player.define('text!../../../_base/js/desktop/resources/atividadeGaveta/template.html',[],function () { return '<div id="{{_id}}" class="{{class}}" style="{{style}}">\n\t\t<div class="gaveta">\n\t\t\t<ul style="padding-left:0px">\n\t\t\t\t{{#gavetas}}\n\t\t\t\t\t<li id="{{parGaveta}}">\n\t\t\t\t\t\t<strong>{{&nome}}</strong>\n\t\t\t\t\t</li>\n\t\t\t\t{{/gavetas}}\n\t\t\t</ul>\n\t\t</div>\n\t\t<div class="bordaGavetaTexto gavetaTextoSelected">\n\t\t\t<div class="gavetaTexto">\n\t\t\t\t{{#gavetas}}\n\t\t\t\t\t<div class="texto" data-gaveta="{{parGaveta}}" style="display:none">\n\t\t\t\t\t\t<h1>{{&tituloAtividade}}</h1>\n\t\t\t\t\t\t<p>{{&content}}</p>\n\t\t\t\t\t\t<img src="{{urlImage}}" style="{{imageStyle}}">\n\t\t\t\t\t</div>\n\t\t\t\t{{/gavetas}}\t\t\n\t\t\t</div>\n\t\t</div>\n</div> <!--atividadeGaveta-->\n\n\n';});


player.define('text!../../../_base/js/desktop/resources/atividadeGaveta/edition.html',[],function () { return '<!-- <div class="resourceEdition"> -->\n\t<div id="editAtividade" class="editionBlock bottom" data-position="left top+10|left bottom">\n\n\t\t<h6>Selecione as alternativas que estarão corretas para esta questão.</h6>\n\t\t\n\t\t<div class="mbBalloonOptions parent">\n\t\t\t<div class="btn-group editionGroupSwitch" data-value="true|false">\n\t\t\t\t<button class="btn btn-default selected" type="button" data-attr="tipo.active">\n\t\t\t\t\t<div data-icon="_" class="icon"></div>\n\t\t\t\t\t<span>TIPO</span>\n\t\t\t\t</button>\n\t\t\t\t<button class="btn btn-default" type="button" data-attr="nota.active">\n\t\t\t\t\t<div data-icon="{" class="icon"></div>\n\t\t\t\t\t<span>NOTA</span>\n\t\t\t\t</button>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class="mbBalloonOptions mbBalloonSubOptions recAtividadeSubType" data-type="tipo">\n\t\t\t<div class="btn-group editionGroud" data-attr="tipo.subType">\n\t\t\t\t<button class="btn btn-default" type="button" value="radio">\n\t\t\t\t\t<div data-icon="v" class="icon"></div>\n\t\t\t\t\t<span>Única Escolha</span>\n\t\t\t\t</button>\n\t\t\t\t<button class="btn btn-default" type="button" value="checkbox">\n\t\t\t\t\t<div data-icon="x" class="icon"></div>\n\t\t\t\t\t<span>Múltipla Escolha</span>\n\t\t\t\t</button>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class="mbBalloonOptions mbBalloonSubOptions recAtividadeSubType" data-type="nota" style="display:none;">\n\t\t\t<div class="btn-group editionGroud" data-attr="nota.subType">\n\t\t\t\t<button class="btn btn-default" type="button" value="semNota">\n\t\t\t\t\t<div data-icon="[" class="icon"></div>\n\t\t\t\t\t<span>Sem Nota</span>\n\t\t\t\t</button>\n\t\t\t\t<button class="btn btn-default" type="button" value="comNota">\n\t\t\t\t\t<div data-icon="}" class="icon"></div>\n\t\t\t\t\t<span>Com Nota</span>\n\t\t\t\t</button>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class="mbActivityProp">\n\t\t\t<div class="btn-group">\n\t\t\t\t<button id="editionLockPlayer" type="button" class="btn btn-default">\n\t\t\t\t\t<div data-icon="~" class="icon"></div>\n\t\t\t\t\t<span>Bloquear player</span>\n\t\t\t\t</button>\n\t\t\t</div>\n\t\t</div>\n\t\t\n\t</div>\n\n\t<div id="addRemoveBlock" class="bottom" style="">\t\n\t\t<div id="addRemoveTemplate" class="" style="display: none">\n\t\t\t<div class="btn-group">\n\t\t\t\t<button class="btn btn-default" id="mbAddAlternative" value="add" type="button">\n\t\t\t\t\t<div data-icon="0" class="icon"></div>\n\t\t\t\t</button>\n\t\t\t\t<button class="btn btn-default" id="mbRemoveAlternative" value="remove" type="button">\n\t\t\t\t\t<div data-icon="1" class="icon"></div>\n\t\t\t\t</button>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n<!-- </div> -->';});


player.define("json!../../../_base/js/desktop/resources/atividadeGaveta/config.json", function(){ return {
	"defaults": {
		"template": "atividadeGaveta",
		"gavetas": [
			{
				"nome": "Gaveta 1",
				"parGaveta": "g1",
				"tituloAtividade": "1111",
				"content": "111 Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit. 111 Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit 111 Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit"
			},
			{
				"nome": "Gaveta 2",
				"parGaveta": "g2",
				"tituloAtividade": "2222",
				"content": "222 Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit."
			 },
			{
				"nome": "Gaveta 3",
				"parGaveta": "g3",
				"tituloAtividade": "3333",
				"content": "333 Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit."
			},
			{
				"nome": "Gaveta 4",
				"parGaveta": "g3",
		...
		"tituloAtividade": "Introdução à Atividade de Gaveta",
		"content": "Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit.",
		"styleObj": {
			"position": "absolute",
			"top": "15px",
...
player.define('../../../_base/js/desktop/resources/atividadeGaveta/editor',[], function() {
