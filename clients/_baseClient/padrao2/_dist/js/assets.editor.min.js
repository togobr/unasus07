...
player.define("json!../../../_base/config/slides/config.json", function(){ return {
	"defaults": {
		"name": "Novo slide",
...
player.define('text!../../../_base/js/desktop/slides/slideCapa/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}; " id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa">\n\t\t<div class="texto titulo primario">\n\t\t\t<div class="tagP">{{&title}}</div>\t\n\t\t</div>\n\t</div>\n</div>\n';});


player.define("json!../../../_base/js/desktop/slides/slideCapa/config.json", function(){ return {
	"defaults": {
...
player.define('../../../_base/js/desktop/slides/slideCapa/editor',[], function() {
...
player.define('../../../_base/js/desktop/slides/slideFinal/editor',[], function() {
...
player.define('text!../../../_base/js/desktop/slides/slideSubCapa/template.html',[],function () { return '<div style="{{style}}; background-image:{{background}}" id="{{_id}}" class="{{class}}">\n\t<div class="faixaCapa">\n\t\t<div class="texto titulo secundario">\n\t\t\t<div class="tagP">\n\t\t\t\t{{&title}}\n\t\t\t</div>\t\n\t\t</div>\n\t</div>\n</div>';});


player.define("json!../../../_base/js/desktop/slides/slideSubCapa/config.json", function(){ return {
	"defaults": {
		"title": "Capas são Slides Especiais que Trazem o Título da Secção de Conteúdo."
	},
...
player.define('../../../_base/js/desktop/slides/slideSubCapa/editor',[], function() {
...
player.define('text!../../../_base/js/desktop/slides/slideAnimacao/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t<div class="slideBackground {{^background.src}}noContent{{/background.src}}">\n\t\t<img src="{{#background.src}} {{background.src}} {{/background.src}}" height="100%" width="100%"/>\n\t\t<span class="glyphicon glyphicon-picture"></span>\n\t</div>\n</div>\n';});


player.define("json!../../../_base/js/desktop/slides/slideAnimacao/config.json", function(){ return {
	"defaults": {
		"background": {
			"src": ""
		}
...
player.define('../../../_base/js/desktop/slides/slideAnimacao/editor',[], function() {
...
player.define('text!../../../_base/js/desktop/slides/slideAnimacao/edition.html',[],function () { return '<!-- <div class="resourceEdition"> -->\n\t<div id="recImgEditBox" class="editionBlock" data-position="left top+10|left bottom">\n\t\t<div class="mbOptionsResources mbOptionsBgImage">\n\t\t\t<div class="btn-group">\n\t\t\t\t<button id="slideImgPicker" type="button" class="btn btn-default">\n\t\t\t\t\t<div data-icon="r" class="icon"></div>\t\t\t\t\n\t\t\t\t\t<span>Escolher Imagem</span>\n\t\t\t\t</button>\n\n\t\t\t\t<button id="slideImgEditar" type="button" class="btn btn-default">\t\n\t\t\t\t\t<div data-icon="C" class="icon"></div>\t\t\t\t\n\t\t\t\t\t<span>Editar Imagem</span>\n\t\t\t\t</button>\n\t\t\t</div>\t\t\t\n\t\t</div>\n\t</div>\n<!-- </div> -->\n\n';});


player.define('text!../../../_base/js/desktop/slides/slideVideo/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


player.define("json!../../../_base/js/desktop/slides/slideVideo/config.json", function(){ return {
	"defaults": {
...
player.define('text!../../../_base/js/desktop/slides/slideAudio/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


player.define("json!../../../_base/js/desktop/slides/slideAudio/config.json", function(){ return {
	"defaults": {
...
player.define('text!../../../_base/js/desktop/slides/slideAtividade/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t\n</div>\n';});


player.define("json!../../../_base/js/desktop/slides/slideAtividade/config.json", function(){ return {
	"defaults": {
...
player.define('../../../_base/js/desktop/resources/caixaDestaque/editor',[], function() {
